<div class="modal fade" id="ventanaModalModificarHerr" tabindex="-1" aria-labelledby="ventanaModalModificarHerr" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="row g-3 FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/herramientaAjax.php" method="POST">
                    ...
                    <div class="col-md-12">
                        ...
                        <input class="form-control" name="nombre" id="nombre" type="text" value="" maxlength="90" placeholder="Ingrese nombre de la herramienta" title="Puedes usar letras, numeros y acentos">
                    </div>

                    <div class="col-md-12">
                        <label class="form-label"><b>CATEGORIA:</b></label>
                        <?php echo $insHerramienta->listarComboCategoriasHerramientaControlador('id_ai_categoria_herramienta', 'id_ai_categoria_herramienta_edit'); ?>
                    </div>
