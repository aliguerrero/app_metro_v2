<div class="modal fade" id="ventanaModalModificarMiem" tabindex="-1" aria-labelledby="ventanaModalModificarMiem" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <i class="bx bx-edit-alt fs-1 me-2 text-primary" aria-hidden="true"></i>
                <h5 class="modal-title" id="tituloModal">Modificar Miembro</h5>
            ...
            <div class="modal-body">
                <form class="row g-3 FormularioAjax" action="<?php echo APP_URL ?>app/ajax/miembroAjax.php" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" name="codigo" id="codigo" type="text" value="" placeholder="Ingrese código">
                    </div>

                    <!-- Nombre del Operador -->
                    <div class="col-md-12">
                        <label class="form-label"><b>NOMBRE DEL OPERADOR:</b></label>
                        <input class="form-control" name="nombre" id="nombre" type="text" value="" placeholder="Ingrese Nombre/Apellido">
                    </div>
